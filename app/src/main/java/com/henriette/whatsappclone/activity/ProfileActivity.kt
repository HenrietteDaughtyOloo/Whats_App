...
import com.henriette.whatsappclone.databinding.ActivityProfileBinding
...
//            startActivityForResult(intent, 1)
        ...
        binding.btnContinue.setOnClickListener{
            if (binding.tilUserName.text!!.isEmpty()){
    ...
    private fun uploadInfo(imgUrl: String) {
        val user = UserModel(auth.uid.toString(), binding.tilUserName.text.toString(),
